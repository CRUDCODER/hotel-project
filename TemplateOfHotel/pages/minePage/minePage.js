...
Page({
     ...
     onShow: function () {
       ...
       if (app.globalData.userInfo!=undefined){
         this.setData({
           userHead: app.globalData.userInfo.memberImg,
           userTitle: '您好！尊贵的，' + app.globalData.userInfo.memberName,
           memberMoney: app.globalData.userInfo.memberMoney+'元',
           memberScore: app.globalData.userInfo.memberScore+'分'
         })
       }
