...
Page({
     ...
     searchEvent: function () {
       var startFormat = this.formatDate(this.data.startDate);
       var endFormat = this.formatDate(this.data.endDate);
          if (location == '定位中...') {
               wx.showToast({
                    title: '定位中，请稍后',
                    icon: 'none'
               ...
               wx.navigateTo({
                    url: '../../pages/searchHotel/searchHotel?location=' + this.data.location+'&startDate='+startFormat+'&endDate='+endFormat,
               })
          }
     },
